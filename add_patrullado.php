                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group"> 
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <button id="btnPatrullero" class="btn btn-info" type="button"  onclick="buscarPatrullero();"><span aria-hidden="true" class="glyphicon glyphicon-search"></span> Buscar Patrullero</button> 
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group"> 
                                            ...
                                            <div class="input-group-btn"> 
                                                ...
                                                <button id="btnPatrullado" class="btn btn-success" type="button" onclick="buscarPatrullado();"><span aria-hidden="true" class="glyphicon glyphicon-search"></span> Buscar Patrullado</button> 
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="col-md-6">
